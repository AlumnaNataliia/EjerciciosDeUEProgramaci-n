	...
	public class MenuVehiculos {
		private ArrayList<String> vehiculos = new ArrayList<>();//una lista privada que almacenará cadenas de texto.		
		public static void main(String[] args) {
			//creamos objeto de programa
			MenuVehiculos app = new MenuVehiculos();// con app guardanda en la variable.
			Scanner scanner = new Scanner(System.in);// leer datos ingresados por el usuario desde el teclado.
			
			
			int opcion;// para switch (opcion)
