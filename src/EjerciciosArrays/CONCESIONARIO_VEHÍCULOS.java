...
public class CONCESIONARIO_VEHÍCULOS {
		...
		// menu do-while primero se ejecuta el bloque y luego las condiciones.
		  do {
			  ...
			  //Manejar una llamada de usuario con switch(expresión) con case (valor de caso)
			  	switch (opcion) {
			  	case 1:
			  		insertarVehiculo(scanner);// llamado al método de inserción
			  		break;
			  	case 2: 
			  		eliminarVehiculo(scanner);// llamado al método de eliminación
			  		break;
			  	case 3:
			  		modificarVehiculo(scanner);// llamado al método de modificación
			  		break;
			  	case 4:
			  	...
			  	case 5:
			  		...
			  		break;
			  	case 6:
			  		venderVehiculo(scanner);
			  		break;
			  	case 7:
			  		mostrarVendidos();
			  		break;
			  	case 8:
			  		mostrarPorCliente(scanner);
			  		break;
			  		default:
	...
	private static ArrayList<String> vehiculos = new ArrayList<>();
		  private static void insertarVehiculo(Scanner scanner) {
		...
		// método  para modificar
		  ...
		  private static ArrayList<String> vendidos = new ArrayList<>();
		  private static void venderVehiculo(Scanner scanner){
...
private static void mostrarPorCliente(Scanner scanner) {
	System.out.println("Ingrese el DNI del cliente: ");
	String dni = scanner.nextLine();
